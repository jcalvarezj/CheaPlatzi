"""
Django settings for cheaplatzi project.
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'cheaplatzi_deploy.apps.CheaplatziDeployConfig',
    'corsheaders'
...
WSGI_APPLICATION = 'cheaplatzi.wsgi.application'
...
CACHES = {
    'default': {
        ...
        'KEY_PREFIX': 'cheaplatzi'
    }
}

CACHE_TTL = 60 * 15   # 15 minutes of TimeToLive